...
Создаем нужные файлы и записываем в них текст прогаммы (рис. @fig:001).

![Создание файлов](image/1.png){#fig:001 width=70%}

Исправленный текст файла client.c (рис. @fig:002).

![Текст файла client.c ](image/2.png){#fig:002 width=70%}

Текст файла common.h (рис. @fig:003).

![Текст файла common.h](image/3.png){#fig:003 width=70%}

Исправленный текст файла server.c (рис. @fig:004).

![Текст файла server.c](image/4.png){#fig:004 width=70%}

Тектс файла Makefile (рис. @fig:005).

![Текст файла Makefile](image/4.png){#fig:005 width=70%}

Текст файла client2.c (рис. @fig:006).

![Текст файла client2.c ](image/6.png){#fig:006 width=70%}

Далее прописываем в консоли команду `make` и получаем исполняемые файлы (рис. @fig:007).

![Исполняемые файлы](image/7.png){#fig:007 width=70%}

Проверка работы (рис. @fig:008).
